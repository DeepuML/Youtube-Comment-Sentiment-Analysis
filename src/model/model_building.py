...
# --------------------------------------------------
# Logging configuration for model building stage
# --------------------------------------------------
...
# File handler to save only error-level logs in a file
...
# --------------------------------------------------
# Function: Apply TF-IDF vectorization to training data
# --------------------------------------------------
def apply_tfidf(train_data: pd.DataFrame, max_features: int, ngram_range: tuple) -> tuple:
    """Apply TF-IDF with ngrams to the data."""
    try:
        # Initialize TF-IDF vectorizer with given parameters
...
# --------------------------------------------------
# Function: Train a LightGBM model
# --------------------------------------------------
def train_lgbm(X_train: np.ndarray, y_train: np.ndarray, learning_rate: float, max_depth: int, n_estimators: int) -> lgb.LGBMClassifier:
    ...
    try:
        # Initialize LightGBM classifier with hyperparameters
...
# --------------------------------------------------
# Function: Save trained model to file
# --------------------------------------------------
...
# --------------------------------------------------
# Main function: End-to-end model building process
# --------------------------------------------------
def main():
    try:
        ...
        # Load preprocessed training data from interim directory
        ...
        # Save trained model to root directory
